const CACHE = 'ragamroll-6612bbd';
const ASSETS = [
  './', './index.html', './help.html', './draw.html', './draw.js', './app.js', './worker.js', './version.js', './manifest.webmanifest',
  ...
  './audio/rowtimes.js',
  './core/parser.js', './core/gamaka-inline.js', './core/tuning.js', './core/raga-base.js', './core/raga-base.json', './core/reference.js',
